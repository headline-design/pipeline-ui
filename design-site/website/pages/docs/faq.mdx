...
Yes, but we highly recommend that you obtain your own API key and server url and replace these before building and deploying your app. If you are using the full version of Pipeline UI, these values can be found in the node_modules folder for your app under @pipeline-ui-2/dist/index.js. If using Pipeline Express, they can be found in node_modules/pipeline-express-react/dist/index.js.
