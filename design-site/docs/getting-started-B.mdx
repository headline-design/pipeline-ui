...
WalletConnect is now supported in the standalone Pipeline class and Pipeline Express. It is not yet supported in the full Pipeline UI library but will be soon!
