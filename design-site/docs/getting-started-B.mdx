...
All Pipeline UI libraries and demos execute transactions on the Algorand MainNet by default. To send transactions on the TestNet, check out [SwitchNet Component](./Algo%20Components/SwitchNet)
