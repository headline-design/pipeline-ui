...
A button to connect to WalletConnect. Generates a popup window with a bar code to scan with phone camera. Uppon success, returns the first wallet address.
